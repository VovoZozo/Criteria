...
public class ApplianceFactory {
	...
	public List<Appliance> create(List<String> strAppliancesData){
	  ...
	  private Appliance createLaptop(String[] data){
		  ...
		  Appliance laptop = new Laptop(  batteryCapacity,  operatingSystem,  memoryRom,  systemMemory,
					 centralProcessingUnit,  displayInchs);
	  ...
	  private Appliance createOven(String[] data){
		  ...
		  int capacity = Integer.parseInt(value.get(1));
		  double depth = Double.parseDouble(value.get(2));
		  double weight = Double.parseDouble(value.get(3));
	  ...
	  private Appliance createRefrigerator(String[] data){
		  ...
		  Appliance refrigerator = new Refrigerator(  powerConsumption,  weight,  freezerCapacity,  overallCapacity,
					 height,  width);
	  ...
	  private Appliance createTabletPC(String[] data){
		  ...
		  int batteryCapacity = Integer.parseInt(value.get(0)); 
		  String color = value.get(1);
		  int memoryRom = Integer.parseInt(value.get(2));
		  int flashMemoryCapacity = Integer.parseInt(value.get(3));
		  int displayInchs = Integer.parseInt(value.get(4));
	  ...
	  private List<String> criteriaValue(String[] criterias) {
		  ...
		  for (String criteria : criterias) {
			  ...
			  value.add(criteria.substring(index));
		  }
